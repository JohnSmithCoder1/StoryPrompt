...
class StoryPrompts {
  ...
  static var stubs = [
    [
      "The <adjective> <noun> saved the day when they <verb> over <number> oceans to return the crown to the princess. Until the villain showed up to <verb2> their plans by bringing <number2> <adjective2> <noun2>...",
